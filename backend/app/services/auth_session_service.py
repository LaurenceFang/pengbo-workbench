...
ROUTE_PERMISSION_MAP: list[RoutePermissionClassification] = [
    ...
    RoutePermissionClassification(
        method="POST",
        path="/api/v1/research/briefs/{brief_id}/export",
        surface="research",
        exposure="account_sensitive",
        permission="reports:export",
        notes="Research exports can include user notes and local evidence summaries; raw secrets and runtime databases are excluded.",
    ),
    RoutePermissionClassification(
        method="POST",
    ...
    RoutePermissionClassification(
        ...
        surface="settings_runtime",
        exposure="account_sensitive",
        permission=None,
        notes="Runtime paths and diagnostics locations are local-only metadata and require local unlock.",
    ),
    RoutePermissionClassification(
        method="GET",
        ...
        exposure="account_sensitive",
        permission=None,
        notes="Portfolio transactions can include local user financial records and are hidden while locked.",
    ),
    RoutePermissionClassification(
        method="GET",
        path="/api/v1/research/briefs/{brief_id}",
        surface="research",
        exposure="account_sensitive",
        permission=None,
        notes="Research briefs can include local notes and evidence chains and are hidden while locked.",
    ),
    RoutePermissionClassification(
        method="GET",
